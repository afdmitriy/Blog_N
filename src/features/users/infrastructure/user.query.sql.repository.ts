...
// import { OutputUsersWithQuery, UserOutputModel } from '../api/models/output/user.output.model';
...
//   async getAll(sortData: UserSortData): Promise<OutputUsersWithQuery | false> {
...
//     const allDtoUsers: OutputUsersWithQuery = users.map(userMapper);
